...
export function Checkbox({ checked, className }: { checked?: boolean; className?: string }) {
  return (
    <RadixCheckbox.Root
      className={cn(
        className,
        'flex h-4 w-4 flex-shrink-0 appearance-none items-center justify-center rounded border border-neutral-300 bg-neutral-100 outline-none dark:border-neutral-800 dark:bg-neutral-900'
      )}
      id="terms"
      checked={checked}
    >
