// Credit: https://github.com/ncdai/chanhdai.com / https://www.kibo-ui.com/components/contribution-graph
	...
	return (
		...
		>
			...
			{new Array(maxLevel + 1).fill(undefined).map((_, level) =>
				children ? (
					// biome-ignore lint/suspicious/noArrayIndexKey: static level scale
