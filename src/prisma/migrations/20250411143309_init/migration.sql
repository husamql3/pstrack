...
CREATE TABLE "leetcoders" (
    ...
    "status" "LeetcodeStatus" NOT NULL DEFAULT 'PENDING',
...
-- AddForeignKey
ALTER TABLE "submissions" ADD CONSTRAINT "submissions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "leetcoders"("id") ON DELETE CASCADE ON UPDATE CASCADE;
