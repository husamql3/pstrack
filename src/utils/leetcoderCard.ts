 ...
 */
export const extractUsername = (input: string, platform: 'github' | 'twitter' | 'linkedin'): string => {
  const patterns = {
 ...
 */
export const getSocialLink = (username: string, platform: 'github' | 'twitter' | 'linkedin'): string => {
