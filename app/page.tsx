...
function Home() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center flex-col gap-4 px-4 py-12">
      <Pill className="z-50 text-[10px] md:text-xs bg-zinc-950/90 border-zinc-900/90 text-zinc-50 backdrop-blur-sm shadow-lg">
