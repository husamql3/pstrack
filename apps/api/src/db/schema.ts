...
// 			.notNull(),
// 	},
// 	(table) => [index("group_createdById_idx").on(table.createdById), index("group_isActive_idx").on(table.isActive)],
// );
...
// 		topics: problemTopicEnum("topics").notNull(),
...
// 		// optional context
// 		userSolveId: uuid("user_solve_id").references(() => userSolve.id, { onDelete: "set null" }),
